...
import { LuUserRound } from 'react-icons/lu'; // Import the user icon
import { MdOutlineMail } from 'react-icons/md'; // Import the email icon
import { TbLockPassword } from 'react-icons/tb'; // Import the password icon
import { FcGoogle } from 'react-icons/fc'; // Import the Google icon
import { FaApple } from 'react-icons/fa'; // Import the Apple icon
